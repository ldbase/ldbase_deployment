echo "drupal-apache-config.sh started." >> /root/build-process.txt
...
cp /ldbase/assets/apache.php.ini /etc/php/7.2/apache2/php.ini
service apache2 restart

echo "drupal-apache-config.sh completed." >> /root/build-process.txt
