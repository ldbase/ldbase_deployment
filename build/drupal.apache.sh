echo "\n\nConfiguring Apache server for Drupal..." >> /root/drupal.apache.txt 2>&1
...
service apache2 restart >> /root/drupal.apache.txt 2>&1
echo "Done configuring Apache server for Drupal..." >> /root/drupal.apache.txt 2>&1
